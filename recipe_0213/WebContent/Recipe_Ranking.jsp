...
<head>
	...
	<link rel="stylesheet" href="Recipe_CSS/Recipe_Rangking.css"/>
	...
	<script src="js/Recipe_Rangking.js"></script>
		...
		<div class="searchRank">
			<div class="rcp_m_list2">
				<ul class="search_word_object">
					<li role="presentation" class="active rtype">
						<a href="Controller?command=ranking_page&rtype=r&ptype=d">레시피</a>
					</li>
					<li role="presentation" class="non-active rtype">
						<a href="Controller?command=ranking_page&rtype=k&ptype=d">검색어</a>
					</li>
					<li role="presentation" class="non-active rtype">
 						<a href="Controller?command=ranking_page&rtype=c&ptype=d">쉐프</a>
					</li>
					<ul class="peroiod">
						<li role="presentation" class="active ptype">
							<a href="Controller?command=ranking_page&ptype=d&rtype=r">일간</a>
						</li>
						<li role="presentation" class="non-active ptype">
							<a href="Controller?command=ranking_page&ptype=w&rtype=c">주간</a>
						</li>
						<li role="presentation" class="non-active ptype">
							<a href="Controller?command=ranking_page&ptype=m&rtype=c">월간</a>
						</li>
					</ul>
				</ul>
			</div>
			<div class="row">
				<!-- 게시글 -->
				<ul class="rank_recipe" style="display: none;">
					<%
						int i = 1;
				...
				<ul class="ranking_search_word">
					...
					<li>
						<div class="search_word_list">
							...
							<a href="/recipe/list.html?q=<%=top100Searchword.get(k)%>"><%=top100Searchword.get(k)%></a>
						</div>
					</li>
					<%
						++i;
				...
				<!-- 유저 -->
				<ul class="ranker_user_list" style="display: none;"><!--  style="display: none;"> -->
						<%
							i = 1;
