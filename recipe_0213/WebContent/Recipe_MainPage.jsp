	...
	<dd class="container">
	  ...
	  <!--쇼핑베스트-->
		<div class="body_content">
			<div class="manager_btn hidden">
				<div>
					<a href="" target="_blank" class="edit">편집
					</a>
					<a href="" target="_blank" class="onedit">추가
					</a>
					<a href="" target="_blank" class="onedit">삭제
					</a>
					<a href="" target="_blank" class="onedit">완료
					</a>
				</div>
			</div>
			...
			<dd style="margin-top:-10px;">
				<div class="user_list" id="user_list">
					...
					<li class="li_user_list" style="text-align: center; width: 110px;">
						<a href="/mypage_recipe_view&u_Id="<%=ruVO.getUserID() %> style="display:table-cell;padding:10px;">
