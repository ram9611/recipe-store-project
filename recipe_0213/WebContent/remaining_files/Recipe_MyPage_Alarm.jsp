...
<head>
	...
	<link href="Recipe_CSS/Recipe_MyPage_Alarm.css" rel="stylesheet">
...
<!-- /최근활동쉐프 추천 6/30개-->
				<div id="div_mypage_alarm_body">
					<div id="div_mypage_alarm_content">
						<div class="div_mypage_alarm_item" id="alarmtype1">
							<div class="mypage_alarm_item_left">
								<div class="mypage_alarm_user_img">
									<a href="#">
										<img src="https://recipe1.ezmember.co.kr/cache/rpf/2020/10/15/679d706ae8cec3828198c200b6ed85311.jpg"/>
									</a>
								</div>
								<div class="mypage_alarm_text">
									<div class="mypage_alarm_title">
										<a href="#">
											<span>ariel1007</span>님이 내 레시피에 댓글을 남겼습니다.
										</a>
									</div>
									<div class="mypage_alarm_detail">
										<a>댓글 내용</a>
									</div>
									<div class="mypage_alarm_time">1시간 9분 전</div>
								</div>
							</div>
							<div class="mypage_alarm_item_right">
								<div class="mypage_alarm_recipe_img">
									<a href="#">
										<img src="https://recipe1.ezmember.co.kr/cache/rpf/2021/09/16/5fe2af6da937d52fee8e3e97188d196a1.jpg"/>
									</a>
								</div>
						...
						<div class="div_mypage_alarm_item" id="alarmtype2">
							<div class="mypage_alarm_item_left">
								<div class="mypage_alarm_user_img">
									<a href="#">
										<img src="https://recipe1.ezmember.co.kr/cache/rpf/2021/09/16/5fe2af6da937d52fee8e3e97188d196a1.jpg"/>
								...
								<div class="mypage_alarm_text">
									<div class="mypage_alarm_title">
										<a href="#">
											<span>햇살머금은집</span>님이 내 댓글에 답글을 남겼습니다.
										</a>
									</div>
									<div class="mypage_alarm_detail">
										<a>답글 내용답글 내용답글 내용답글 내용답글 내용답글 내용답글 내용답글 내용답글 내용답글 내용답글 내용답글 내용답글 내용답글 내용답글 내용답글 내용답글 내용답글 내용답글 내용답글 내용답글 내용답글 내용답글 내용답글 내용답글 내용답글 내용답글 내용</a>
									</div>
									<div class="mypage_alarm_time">2시간 9분 전</div>
								</div>
							</div>
							<div class="mypage_alarm_item_right">
								<div class="mypage_alarm_recipe_img">
									<a href="#">
										<img src="https://recipe1.ezmember.co.kr/cache/recipe/2023/11/28/d862b355deac2db3ae9a3af1cea618e91_m.jpg"/>
									</a>
								</div>
							</div>
						</div>
						<div class="div_mypage_alarm_item" id="alarmtype3">
							<div class="mypage_alarm_item_left">
								<div class="mypage_alarm_user_img">
									<a href="#">
										<img src="https://recipe1.ezmember.co.kr/cache/rpf/2023/10/11/8beb7e6796445cb9f548f1ab8e0c4b2e1.jpg"/>
									</a>
								</div>
								<div class="mypage_alarm_text">
									<div class="mypage_alarm_title">
										<a href="#">
											<span>ljw</span>님이 팔로우를 시작합니다.
										</a>
									</div>
									<div class="mypage_alarm_time">2023.11.29 14:56</div>
								</div>
							</div>
							<div class="mypage_alarm_item_right">
								<div class="mypage_alarm_followbutton">
									<a href="#">+ 소식받기</a>
								</div>
							</div>
						</div>
						<div class="div_mypage_alarm_item" id="alarmtype4">
							<div class="mypage_alarm_item_left">
								<div class="mypage_alarm_user_img">
									<a href="#">
										<img src="https://recipe1.ezmember.co.kr/cache/rpf/2015/07/29/e4be91d70e81a206b600e8b92217915e1.jpg"/>
								...
								<div class="mypage_alarm_text">
									<div class="mypage_alarm_title">
										<a href="#">
											<span>좋아좋아3</span>님이 채팅방에 초대했습니다.
										</a>
									</div>
									<div class="mypage_alarm_time">4시간 9분 전</div>
								</div>
							</div>
						</div>
					</div>
