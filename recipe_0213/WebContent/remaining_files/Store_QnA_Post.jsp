...
<html>
<head>
	<!-- 만개스토어 1:1문의 답변있는 게시글 -->
	<meta charset="UTF-8">
	<title>Insert title here</title>
	<link href="https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@100;300;400;500;700;900&display=swap" rel="stylesheet">
	<link rel="stylesheet" href="Store_CSS/Store_QnA_Post.css" type="text/css"/>
			...
			<div id="div_store_cs_panel">
				...
				<div id="div_store_cs_body">
					<div id="div_store_cs_content">
						<div id="div_store_cs_post_title">
							test
						</div>
						<div id="div_store_cs_post_info">
							<span class="post_writer">
								<strong>이진우</strong>
								<b>(IP: 106.249.191.*)</b>
							</span>
							<span class="post_write_date">
								<em>2023.12.04 09:39:47</em>
							</span>
							<span class="post_hits">
								<strong>조회수</strong>
								3
							</span>
						<div style="clear:both;"></div>
						</div>
						<div id="div_store_cs_post_content">
							<div id="div_store_cs_post_Q">
								<strong>Q.</strong>
								<div id="div_store_cs_post_Q_content">
									<div style="margin:10px 0 10px 0">
										<p>&nbsp;</p><p>주문하신 경우 양식에 맞게 항목을 기재해주시면 빠른 업무처리가 가능합니다.</p><p>휴일간 문의사항은 휴무일 이후 순차적으로 처리해드리겠습니다.</p><p>&nbsp;</p><p>주문번호 :&nbsp;</p><p>상품명 :&nbsp;</p><p>주문자 이메일 :&nbsp;</p><p>주문자 전화번호 :&nbsp;</p><p>----------------------------------------------</p><p>&nbsp;</p><p>&nbsp;</p>
									</div>
								</div>
							</div>
							<div id="div_store_cs_post_A">
								<strong>A.</strong>
								<div id="div_store_cs_post_A_header">
									<strong>-</strong>
									<span>
										<strong>관리자</strong>
									</span>
									<span>
										<em>2023-12-04 11:28:13</em>
									</span>
								</div>
								<div id="div_store_cs_post_A_content">
									<div style="margin:10px 0 10px 0">
										<p>-</p>
									</div>
								</div>
