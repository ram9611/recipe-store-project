...
<html>
<head>
	<!-- 만개스토어 1:1문의 게시글 작성페이지 -->
	<meta charset="UTF-8">
	<title>Insert title here</title>
	<link href="https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@100;300;400;500;700;900&display=swap" rel="stylesheet">
	<link rel="stylesheet" href="Store_CSS/Store_QnA_Write.css" type="text/css"/>
...
<body>
	...
	<div class="main_cont_wrap">
		<div id="div_store_body">
			...
			<div id="div_store_qna">
				<div id="div_store_qna_panel">
					<div id="div_store_qna_content">
						<div id="div_store_qna_title">
							<div>1:1문의</div>
						</div>
						<div id="div_store_qna_body">
							<form name="store_qna_write">
								<div id="div_store_qna_board">
									<table id="table_board">
										...
										<tbody>
											<tr>
												<th scope="row" id="cs_head">말머리</th>
												<td>
											...
											<tr>
												<th scope="row" id="cs_writer">작성자</th>
												<td>이진우</td>
											</tr>
											<tr>
												<th scope="row" id="cs_phone">휴대폰</th>
												<td>
													<input type="text" id="input_phone" placeholder="- -없이 입력하세요"/>
												</td>
											</tr>
											<tr>
												<th scope="row" id="cs_email">이메일</th>
												<td>
											...
											<tr>
												<th scope="row" id="cs_title">제목</th>
												<td>
													<input type="text" id="input_title"/>
												</td>
											</tr>
											<tr>
												<th scope="row" id="cs_content">본문</th>
												<td>
													스마트에디터 삽입구간
												</td>
											</tr>
											<tr>
												<th scope="row" id="cs_file">첨부파일</th>
												<td>
													<div id="div_file_upload">
														<input type="text" id="input_file" readonly/>
														<div id="div_file_upload_button">
											...
											<tr>
												<th scope="row" id="cs_capcha">자동등록방지</th>
												<td>
													<div id="div_capcha">
														<div id="div_capcha_img">
															<img src="https://shop.10000recipe.com/board/captcha.php"/>
														</div>
														<div id="div_capcha_text">
															<div>
																보이는 순서대로<br/>
																숫자 및 문자를 모두 입력해 주세요.
															</div>
															<input type="text" id="capcha_text"/>
															<button type="button" id="reload_capcha">
																<span>
																	<img src="https://shoptr3131.cdn-nhncommerce.com/data/skin/front/moment/board/skin/qa/img/icon/icon_reset.png"/>
																	이미지 새로고침
																</span>
															</button>
														</div>
								...
								<div id="div_store_qna_button">
									<button type="button" id="button_before">이전</button>
									<button type="button" id="button_write">저장</button>
								</div>
							</form>
						</div>
					</div>
