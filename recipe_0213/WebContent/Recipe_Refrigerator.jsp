				...
				<div id="div_login_button" class="fl">
					...
					<% } else { // 로그인 상태라면 %>
						<script>
							...
							let map;
							$(function() {
								$(".search_results").on("click", "tbody > tr",  function() {
									let r_id = $(this).attr("recipe");
...
<!-- 페이지 상단 메뉴바 -->
	<div class="container">
		<div class="Refrigerator">
			...
			<table class="Table_UsersIngredi">
				<tbody>
					<tr>
						<td id="table_usersIngredi_td_1"></td>
						<td id="table_usersIngredi_td_2"></td>
						<td id="table_usersIngredi_td_3"></td>
					</tr>
					<tr>
						<td id="table_usersIngredi_td_4"></td>
						<td id="table_usersIngredi_td_5"></td>
						<td id="table_usersIngredi_td_6"></td>
					</tr>
					<tr>
						<td id="table_usersIngredi_td_7"></td>
						<td id="table_usersIngredi_td_8"></td>
						<td id="table_usersIngredi_td_9"></td>
					</tr>
				</tbody>
			</table>
		</div>
				...
				<div class="input_UsersIngredi">
					<div id="div_ingredi_search_bar">
						<script type="text/javascript">
							...
							%>
							ingredientoptions.push({value: <%=riVo.getIngredieID()%>, text:"<%=riVo.getingredieName()%>"});
						    <%
								}
							%>			 
											...
											$.ajax({
												...
												success: function (result) {
													...
													$.each(result, function(index, item) {
														...
														const add_img_html = "<img src="+ result[index].image + " alt="+result[index].ingrediName+">";
														console.log(add_img_html);
														$(add_img_html).appendTo("#table_usersIngredi_td_"+(index+1));
													
														arr_for_have_with_span = $.map(result[index].arrForHave, function(ingredient) {
															return "<span>" + ingredient + "</span>";
														});
														arr_for_not_with_span = $.map(result[index].arrForNot, function(ingredient) {
															return "<span class='missing_material'>" + ingredient + "</span>";
														});
														const add_html = 
															"<tr recipe=" + result[index].recipeID + ">" +
															"<td class='results_thumbnail'> <img src=" + result[index].thumbnail + " alt=" + result[index].title + "/> </td>" +
															"<td class='results_name'>" + result[index].title + "</td>" +
														...
														//result[index].image
														//result[index].ingrediName
														//const add_img_html = '<td> <img src='+ item.image + " alt="+item.ingrediName+"> </td>"
														//$(".Table_UsersIngredi > tbody > tr").append('<td> <img src='+ result[index].image + " alt="+result[index].ingrediName+'> </td>');
														//$(add_img_html).appendTo(".Table_UsersIngredi > tbody > tr");
													});
												},
  ...
  <div id="div_recent_recipe_panel">
    <div id="div_recent_recipe_content">
      ...
      <div id="div_recent_recipe_body">
        <a href="#" class="rr_list_button_previous">
          <img src="https://recipe1.ezmember.co.kr/img/btn_arrow1_l.png" alt="이전" />
        </a>
        <a href="#" class="rr_list_button_next">
          <img src="https://recipe1.ezmember.co.kr/img/btn_arrow1_r.png" alt="다음" />
        </a>
        <div class="recent_recipe">
          <a class="rr_recipe_thumbnail">
            <img src="https://recipe1.ezmember.co.kr/cache/recipe/2019/04/14/67b39b7159fa14c51042fe0674e7399f1_m.jpg"
              class="rr_recipe_thumbnail_img" />
            <div class="rr_recipe_title"> 기름 없이 볶아 다이어트에 좋은 중국식 청경채 돼지...
            </div>
          </a>
        </div>
        <div class="recent_recipe">
          <a class="rr_recipe_thumbnail">
            <img src="https://recipe1.ezmember.co.kr/cache/recipe/2018/09/30/16fc5e69d9c7624353361f4a65f4752a1_m.jpg"
              class="rr_recipe_thumbnail_img" />
            <div class="rr_recipe_title"> 실패는없다!백종원 냉국레시피!...
            </div>
          </a>
        </div>
        <div class="recent_recipe">
          <a class="rr_recipe_thumbnail">
            <img src="https://recipe1.ezmember.co.kr/cache/recipe/2018/10/07/da4e0452ac3bd20bb0528f4abc1211881_m.jpg"
              class="rr_recipe_thumbnail_img" />
            <div class="rr_recipe_title"> 꿀마늘 닭강정(아이들 단골메뉴 찜♡♡)...
            </div>
          </a>
        </div>
        <div class="recent_recipe">
          <a class="rr_recipe_thumbnail">
            <img src="https://recipe1.ezmember.co.kr/cache/recipe/2019/01/22/209d1b0860d71c45978f804721f107f71_m.jpg"
              class="rr_recipe_thumbnail_img" />
            <div class="rr_recipe_title"> 아이들이 좋아하는 초간단 간식, 퐁크러쉬 쉐이크 레...
            </div>
          </a>
        </div>
        <div class="recent_recipe">
          <a class="rr_recipe_thumbnail">
            <img src="https://recipe1.ezmember.co.kr/cache/recipe/2019/05/21/52ec68320e673157a36e0bdce94f89561_m.jpg"
              class="rr_recipe_thumbnail_img" />
            <div class="rr_recipe_title">에어프라이어 소시지 피자...</div>
          </a>
        </div>
        <div class="recent_recipe">
          <a class="rr_recipe_thumbnail">
            <img src="https://recipe1.ezmember.co.kr/cache/recipe/2015/05/05/f898a7e9e03e179c2c6b7ad65fd946321_m.jpg"
              class="rr_recipe_thumbnail_img" />
            <div class="rr_recipe_title">차돌박이 파스타</div>
          </a>
        </div>
      </div>
    </div>
    ...
    <div id="footer1_panel">
      <div id="footer1_content1">
        ...
        <p class="f_content1_info">
          대표 : YG / E : help@10000recipe.com / F : 02) 323-5049 <br />
        ...
        <p class="f_content1_info">
          ...
          2022-서울금천-3089 / 벤처기업확인 /
          <a href="#" target="_self" style="color: #999; font-size: 13px">사업자정보확인</a>
          <br />
          서울지방중소기업청 제 031134233-1-01643호
        </p>
        <p class="f_content1_info">
          Copyright <b style="font-size: 13px">만개의레시피</b> Inc. All
          Rights Reserved
        </p>
      </div>
...
만개의레시피에 전하고 싶은 의견을 남겨주세요."></textarea>
        ...
        <p id="f_cs_notice">
          개별회신을 원하시면
          <a href="#" style="text-decoration: underline; color: #666; font-size: 13px">여기</a>에 문의하세요.
        </p>
      </div>
    </div>
  </div>
    ...
    <div id="footer2_panel">
      ...
      <div id="f2_all_count">
        <div class="div_count_box">
          <a href="#">
            <span style="
                  background: url(//recipe1.ezmember.co.kr/img/btm_icon1.png)
                    center no-repeat;
                "></span>
            제휴업체수
          </a>
        ...
        <div class="div_count_box">
          <a href="#">
            <span style="
                  background: url(//recipe1.ezmember.co.kr/img/btm_icon2.png)
                    center no-repeat;
                "></span>
            총 쉐프수
          </a>
        ...
        <div class="div_count_box">
          <a href="#">
            <span style="
                  background: url(//recipe1.ezmember.co.kr/img/btm_icon3.png)
                    center no-repeat;
                "></span>
            총 레시피수
          </a>
        ...
        <div class="div_count_box">
          <a>
            <span style="
                  background: url(//recipe1.ezmember.co.kr/img/btm_icon4.png)
                    center no-repeat;
                "></span>
            월 방문자수
          </a>
        ...
        <div class="div_count_box">
          <a>
            <span style="
                  background: url(//recipe1.ezmember.co.kr/img/btm_icon5.png)
                    center no-repeat;
                "></span>
            총 레시피 조회수
          </a>
